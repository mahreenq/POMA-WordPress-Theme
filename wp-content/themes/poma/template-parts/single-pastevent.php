...
<article id="post-<?php the_ID(); ?>" class="powderBlueBackground padding-top-xl padding-bottom-xlg flex-tablet flex-direction-column align-items-center-tablet justify-content-center-tablet">
	...
	<header class=" ">
	<?php if ( is_single() ) {		
		the_title( '<h1 class="entry-title padding-top-med oswald greyText underlineTeal lgFont text-align-center uppercase">', '</h1>' );
		} else {
